...
@Component
@Slf4j
public class StateHistoryHelperImpl implements StateHistoryHelper {

    @Autowired
    CabTransformer cabTransformer;

    @Override
    public boolean updateCabStatus(Map<String, ConcurrentNavigableMap<Long, CabEntry>> _allStates, Cab cab) {
        /**
    ...
    @Override
    public Long getCabIdleTimeInMillis(Map<String, ConcurrentNavigableMap<Long, CabEntry>> _allStates, String registrationNumber, Long startTime, Long endTime) throws AnalyticsException {
        Long response = 0L;
        ...
        return getIdleTime(_allStates, iterator, registrationNumber, startTime, endTime);
    }

    @Override
    public List<CabEntry> getCabStates(Map<String, ConcurrentNavigableMap<Long, CabEntry>> _allStates, String registrationNumber, Long startTime, Long endTime) throws AnalyticsException {
        /**
